            ...
            @foreach ($orders as $order)
                <tr>
                    ...
                    <td>
                        ...
                        {{-- karena coloumn medicines tipe datanya berbentuk array json, maka untuk mengaksesnya perlu di looping juga --}}
                        <ol>
                    ...
                    {{-- carbon : package bawaan laravel untuk mengatur hal hal yang berkaitan dengan tipe data/datetime --}}
                    @php
                    // setting lokal time sebagai wilayah indonesia
                        setlocale(LC_ALL, 'IND');   
                    @endphp
                    <td>{{ Carbon\Carbon::parse($order->created_at)->formatLocalized('%d %D %Y') }}</td>
